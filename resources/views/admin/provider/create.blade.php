...
<div class="row">
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h1 class="card-title">Create Provider</h1>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form role="form" id="quickForm" action="{{ route('providers.store') }}" method="POST" style="font-size:18px;padding:20px;">
            @csrf
                        ...
                        <div class="col-sm-8">
                          <div style="display:flex;">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" name="phone" class="form-control  @error('phone') is-invalid @enderror" id="exampleInputPhone1" data-inputmask='"mask": "(999) 999-9999"'  value="{{ old( 'phonetmp') }}" data-mask>
                              @if( $errors->has( 'phone' ) )
            ...
            <div class="card card-secondary">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                        <input type="text" name="companyname" class="form-control  @error('companyname') is-invalid @enderror" id="exampleInputCompany1" placeholder="Company" value="{{ old( 'companyname') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                        <input type="text" name="addline1" class="form-control" id="exampleInputAddline1" placeholder="Address Line1" value="{{ old( 'addline1') }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-4"></div>
                        <div class="col-sm-8">
                        <input type="text" name="addline2" class="form-control" id="exampleInputAddline2" placeholder="Address Line2" value="{{ old( 'addline2') }}">
                        </div>
                    </div>
                    <div class="form-group row">
