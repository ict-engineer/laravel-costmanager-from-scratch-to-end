...
<div class="row">
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h1 class="card-title">Edit service Info</h1>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form role="form" id="quickForm" action="{{ route('services.update',$service->id) }}" method="POST" style="font-size:18px;padding:20px;">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="exampleInputName1" placeholder="Name"  value="{{ old( 'name', $service->name ) }}">
                      @if( $errors->has( 'name' ) )
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="spanish" class="form-control" placeholder="Spanish Name"  value="{{ old( 'spanish', $service->spanish ) }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4 col-form-label">French</label>
                    <div class="col-sm-8">
                      <input type="text" name="french" class="form-control" placeholder="French Name"  value="{{ old( 'french', $service->french ) }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Italian</label>
                    <div class="col-sm-8">
                      <input type="text" name="italian" class="form-control" placeholder="Italian Name"  value="{{ old( 'italian', $service->italian ) }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Russian</label>
                    <div class="col-sm-8">
                      <input type="text" name="russian" class="form-control" placeholder="Russian Name"  value="{{ old( 'russian', $service->russian ) }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4 col-form-label">German</label>
                    <div class="col-sm-8">
                      <input type="text" name="german" class="form-control" placeholder="German Name"  value="{{ old( 'german', $service->german ) }}">
                    </div>
                </div>
            </div>
            <!-- /.card-body -->
