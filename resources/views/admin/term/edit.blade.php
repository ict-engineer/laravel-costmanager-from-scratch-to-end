...
<div class="row">
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h1 class="card-title">Edit Terms and Conditions</h1>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        
        <form role="form" id="quickForm" action="{{ route('terms.update',$term->id) }}" method="POST" style="font-size:18px;padding:20px;">
            @csrf
            @method('PUT')
            ...
            <div class="card-footer">
                <a href="/terms" class="btn btn-secondary float-right" style="margin-left:10px;">Cancel</a>
