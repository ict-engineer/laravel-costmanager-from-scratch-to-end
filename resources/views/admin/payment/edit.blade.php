...
<div class="row">
    ...
    <div class="card card-primary">
        ...
        <form role="form" id="quickForm" action="{{ route('payments.update',$payment->id) }}" method="POST" style="font-size:18px;padding:20px;">
            @csrf
            @method('PUT')
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                <input type="text" name="name" id="name" class="form-control  @error('name') is-invalid @enderror" placeholder="Name" value="{{ old( 'name', $payment->name) }}">
                @if( $errors->has( 'name' ) )
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                <input type="text" name="numberofusers" class="form-control" id="exampleInputCp1" placeholder="Number of Users" value="{{ old( 'numberofusers', $payment->numberofusers) }}">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                <input type="text" name="price" class="form-control" id="price" placeholder="Price" value="{{ old( 'price', $payment->price) }}">
                </div>
            </div>
            <div class="form-group row">
