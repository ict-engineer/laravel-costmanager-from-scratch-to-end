    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 style="display:inline;margin-left:0.5rem;"><i class="fas fa-users nav-icon"></i></h3>
                @can('New Users')
                <a style="display:inline;float:right;margin-right:0.5rem;" href="{{ route('usersetup.create') }}" class="btn btn-primary">
                ...
                <table id="example1" class="table table-bordered table-hover" style="font-size:18px;vertical-align: middle;">
                    ...
                    @foreach ($users as $user)
                        ...
                        <td>
                                ...
                                <a class="btn btn-info  " href="{{ route('usersetup.show',$user->id) }}">View</a>
                            
                            @can('Edit Users')
                                <a class="btn btn-primary " href="{{ route('usersetup.edit',$user->id) }}">Edit</a>
                            @endcan
                            @can('Delete Users')
                                <button class="btn btn-danger  remove-user" data-id="{{ $user->id }}" data-action="{{ route('usersetup.destroy',$user->id) }}">Delete</button>
                            @endcan
                        </td>
                        @else
                            <td>Super Admin</td>
