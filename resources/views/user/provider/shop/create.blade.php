...
@endsection
@section('pagetitle')
<h5 class="breadcrumbs-title mt-0 mb-0 display-inline hide-on-small-and-down"><span>{{ __('messages.New') }} {{ __('messages.Shop') }}</span></h5>
<ol class="breadcrumbs mb-0">
    ...
    <li class="breadcrumb-item active">{{ __('messages.New') }} {{ __('messages.Shop') }}
    </li>
</ol>
@endsection
@section('content')
    ...
    <div class="row">
        <div class="col s12">
            ...
            <div class="card-content">
                <form role="form" id="quickForm" action="{{ route('user.providershops.store') }}" method="POST" class="mt-1">
                    @csrf
                        ...
                        <div class="col l6 s12">
                            <div class="row">
                                <div class="input-field col s12">
                                    ...
                                    <input type="text"  class="validate" name="name" id="name"  value="{{ old( 'name') }}" >
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    ...
                                    <input type="text"  class="validate" name="addline1" id="addline1"  value="{{ old( 'addline1') }}" >
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    ...
                                    <input type="text"  class="validate" name="cp" id="cp"  value="{{ old( 'cp') }}" >
                    ...
                    <div class="row">
                        <div class="col s12 display-flex justify-content-end mt-3">
                            <button type="submit" class="btn indigo" style="margin-right:1rem;">{{ __('messages.Create') }}</button>
